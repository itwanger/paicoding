...
const planText = ref('### 系统更新\n' +
    ...
    '#### 新增功能\n' +
    '\n' +
    '- [x] LLM对话使用Spring AI接入，支持更多大模型\n' +
    '- [x] 引入Token分配机制，用户可查看和管理LLM使用配额\n' +
    '- [x] 个人信息页面UI优化，将公司和职位信息整合到个人简介卡片中\n' +
    '- [x] 为各标签页添加Element Plus空状态组件，提升用户体验\n' +
    '- [x] 将"工具"页面移至顶部导航栏，与LLM、关于作者并列\n' +
    '\n' +
    '#### 技术升级\n' +
    '\n' +
    '- [x] SpringBoot升级至3.5.5，支持最新Spring AI框架\n' +
    '- [x] 前端项目重构优化，改进组件结构和代码质量\n' +
    '\n' +
    '#### UI优化\n' +
    '\n' +
    '- [x] 优化个人信息页面布局，修复内容溢出和覆盖问题\n' +
    '- [x] 空状态页面使用彩色插图，提升视觉效果\n' +
    '- [x] 压缩用户信息区域高度，使背景图与内容完美对齐\n' +
    '\n' +
    '> 更新时间：2025/03/13\n' +
    '\n' +
    '#### bug修复\n' +

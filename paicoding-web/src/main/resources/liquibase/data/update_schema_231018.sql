...
alter table `notify_msg` modify `id` bigint unsigned NOT NULL AUTO_INCREMENT COMMENT '主键ID', `related_id` bigint unsigned NOT NULL DEFAULT '0' COMMENT '关联的主键', `notify_user_id` bigint unsigned NOT NULL DEFAULT '0' COMMENT '通知的用户id', `operate_user_id` bigint unsigned NOT NULL DEFAULT '0' COMMENT '触发这个通知的用户id';

alter table `user` modify `id` bigint unsigned NOT NULL AUTO_INCREMENT COMMENT '主键ID';
alter table `user_ai` modify `id` bigint unsigned NOT NULL AUTO_INCREMENT COMMENT '主键ID', modify `user_id` bigint unsigned NOT NULL DEFAULT '0' COMMENT '用户id', `inviter_user_id` bigint NOT NULL DEFAULT '0' COMMENT '当前用户绑定的邀请者';
...
alter table `user_foot` modify `id` bigint unsigned NOT NULL AUTO_INCREMENT COMMENT '主键ID', modify `user_id` bigint unsigned NOT NULL DEFAULT '0' COMMENT '用户id', modify `document_id` bigint unsigned NOT NULL DEFAULT '0' COMMENT '文档ID（文章/评论）', `document_user_id` bigint unsigned NOT NULL DEFAULT '0' COMMENT '发布该文档的用户ID';

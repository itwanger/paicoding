...
public class WxAckHelper {
    ...
    public BaseWxMsgResVo buildResponseBody(String eventType, String content, String fromUser) {
        ...
        // 微信公众号登录
            ...
            textRes = "/:? 还在找其它资料么？\n" +
                    "\n" +
                    "[机智] 添加二哥的微信 itwangersb 后，微信回复 “110”，即可获得 10 本校招/社招必刷八股文，以及技术派团队的原创手册《高并发手册》、《Spring 源码解析手册》、《设计模式手册》、《JVM 核心手册》、《Java 并发编程手册》、《架构选型手册》，工作面试两不误，工作面试两不误。\n" +
                    "\n" +
                    "商务合作/技术交流群：请添加二哥微信 itwangersb";
        }
